...
import { IsEnum, IsNotEmpty, IsOptional, IsString, IsUUID, Matches, Validate, ValidateNested, ValidationArguments, ValidatorConstraint, ValidatorConstraintInterface } from 'class-validator';
